// Fisher's Iris dataset — 150 samples, 4 features each
// Features: sepal length, sepal width, petal length, petal width (cm)
export const irisFeatureNames = [
  'Sepal Length',
  'Sepal Width',
  'Petal Length',
  'Petal Width',
...
export const irisTargetNames = ['Setosa', 'Versicolor', 'Virginica'];

// Raw iris data: [sepal_length, sepal_width, petal_length, petal_width]
export const irisData: number[][] = [
  // Setosa (0-49)
...
export const irisTargets: number[] = [
  ...Array(50).fill(0),
  ...Array(50).fill(1),
  ...Array(50).fill(2),
];
